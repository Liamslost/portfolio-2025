...
function animateFace() {
  ...
  const x = percentage(xPosRef.current, width) - 50;
  const y = percentage(yPosRef.current, height) - 50;
  const yHigh = percentage(yPosRef.current, height) - 20;
  const yLow = percentage(yPosRef.current, height) - 80;

  gsap.to("#face", {
    yPercent: yLow / 30,
    xPercent: x / 30,
  });
  gsap.to("#right-eye, #left-eye, .pupil", {
    yPercent: yHigh / 3,
    xPercent: x / 2,
  });
  gsap.to("#right-brow, #left-brow", {
    yPercent: y * 2.5,
  });
  ...
  <g id="Layer_2-2" data-name="Layer 2">
    <g id="avatar">
      <g id="sweater">
        ...
        <path className="cls-20" d="M15.89,167.24s-2.43-.46-6.01-2.26c-.69-.35-1.83-.94-1.87-1.8-.02-.37.16-.84.5-1.01.44-.22,1.03.11,1.23.22.5.27,3.51.98,9.52,2.38.57.13,1.71.38,2.52-.22.08-.06.6-.44.58-.94-.02-.56-.71-.95-1.08-1.15-3.14-1.67-7.87-2.05-9.01-4.4-.35-.73-.4-1.73,0-2.02.4-.29,1.09.23,2.16.72.74.34,3.87,1.78,5.69.72,1.11-.64,1.42-2.02,1.51-2.45.29-1.31-.15-2.01-2.02-6.63-3.22-7.96-.92-3.47-1.87-5.69-.16-.38-.61-1.39-.29-1.66.23-.19.76.08,1.01.22,3.03,1.63,5.73,4.23,7.06,3.75,1.28-.46.91-3.59,1.66-3.68.7-.08,1.52,2.56,1.73,3.24,0,0,.33,1.05,4.88,11.26,3.96,8.89,14.86,11.48,14.86,11.48l-32.76-.08Z"/>
        ...
        <path className="cls-20" d="M67.58,125.18c-.89-.06-.72-2.72-2.6-3.6-.58-.27-2.4-.86-1.8-.65,0,0-.21.59-.22.87-.02.63.94,1.12,1.44,1.44,2.12,1.37,1.77,3.65,2.88,3.75.97.08.96-1.68,3.24-3.17.35-.22,1.07-.65,1.51-1.51.2-.39.46-1.08.22-1.3-.22-.2-.78.09-1.01.22-2.21,1.18-2.75,4.03-3.68,3.96Z"/>
        <path className="cls-20" d="M74.04,122c-.12-.13.2-.45,1.5-2.31.39-.56.61-.89.88-.86.29.04.53.48.54.87.02.8-.93,1.4-1.51,1.76-.15.1-1.22.77-1.42.54Z"/>
        <path className="cls-20" d="M61.28,121.62c.11-.14-.24-.43-1.69-2.18-.44-.53-.69-.84-.95-.78-.28.06-.49.52-.46.91.04.8,1.04,1.32,1.65,1.63.16.08,1.28.66,1.46.42Z"/>
      </g>
      <g id="left-ear">
        ...
        <path className="cls-19" d="M38.13,60.59c.15-.16.53-1.42-.04-5.33-.28-.38-.76-.91-1.51-1.24-2.11-.93-4.34.62-4.6.81-2.46,1.78-2.48,5.12-2.49,6-.02,3.67,2.23,6.14,2.87,6.81,0,0,1.25,2.14,5.41,3.81.18.07.77.02.93-.13.17-.17-.12-1.08-.18-1.24-.65-1.78-.39-5.73-.38-5.89.01-.17.05-.6-.22-.87-.19-.19-.4-.16-.65-.27-.5-.22-.68-.8-.81-1.14-.5-1.29-1.63-3.21-2.87-3.2-.29,0-.5-.07-.72-.29-.17-.17-.14-.32-.03-.54.14-.28.55-.26.75-.29,1.05-.17,1.56.56,1.98.83,1.75,1.13,2.44,2.29,2.55,2.17Z"/>
        <path className="cls-18" d="M32.63,63.6c.26.75.68,1.92,1.73,3.06.4.44,1.44,1.54,3.1,1.95.49.12.54.36.78.25,0,0-.1-.61-.05-3.15.03-1.67,0-2.05,0-2.05,0,0-.43-1.02-2.39-3.13,0,0-1.09-2.05-2.26-1.83-.12.02-.53-.59-.77-.52-.36.1-.32.34-.4.49-.9,1.96.25,4.92.25,4.92Z"/>
      </g>
      <g id="right-ear">
      ...
      <g id="face">
        ...
        <path id="face-2" data-name="face" className="cls-19" d="M89.16,40.4c.38-.53,1.76-2.56,1.19-4.87-.29-1.45-1.77-3.69-3.35-2.27-8.35,3.19-26.19,2.82-32.55-.43-3.89-2.24-8.59-3.54-9.73,2.05-.26,1.98.48,2.98.71,4.34.06.32.01.94-.08,1.32-.41,1.66-1.43,1.47-2.79,3.2-1.36,1.72-1.29,3.57-1.3,7.46-.14,4.1-.28,20.9-.11,22.28,1.73,8.81,9.69,14.05,12.65,16,11.78,8.16,24.46,5.64,35.58-6.7,8.5-10.4,3.21-16.45,4.76-34.93l-2.22-4.35-2.76-3.11Z"/>
      </g>
      <path id="right-brow" className="cls-13" d="M89.8,53.1c.32-.32-.98-2.81-2.2-4.07-3.96-4.1-9.76-3.77-12.22-2.85-.44.17-1.11.48-1.51,1.15-.67,1.13-.37,2.88.54,3.5.9.61,2.15-.06,3.24-.4,5.53-1.7,12.15,2.67,12.15,2.67Z"/>
      <path id="left-brow" className="cls-3" d="M46.2,53.1c-.32-.32.98-2.81,2.2-4.07,3.96-4.1,9.76-3.77,12.22-2.85.44.17,1.11.48,1.51,1.15.67,1.13.37,2.88-.54,3.5-.9.61-2.15-.06-3.24-.4-5.53-1.7-12.15,2.67-12.15,2.67Z"/>
      <g id="cheeks">
        <path className="cls-18" d="M88.44,67.77c0,.93-1.49,1.68-2.74,1.68s-2.27-.61-2.27-1.53,1.49-1.82,2.74-1.82,2.27.75,2.27,1.68Z"/>
        <path className="cls-18" d="M46.67,67.77c0,.93,1.49,1.68,2.74,1.68s2.27-.61,2.27-1.53-1.49-1.82-2.74-1.82-2.27.75-2.27,1.68Z"/>
      </g>
      <path id="right-eye-2" d="M75.09,56.3c.03.2-.11,1.68.04,2.22.04.14,2.59-1.42,3.26-1.62.93-.29,2.9-.45,3.88-.42.85.03,3.27.13,3.27.13l1.1,1.51s-.35-1.54-.52-1.91c-.38-.83-1.46-1.12-2.4-1.14s-2.07-.07-3.02-.1c-1.22-.03-5.78.22-5.6,1.34Z"/>
      <path id="left-eye-2" d="M60.89,56.43c-.03.2.11,1.68-.04,2.22-.04.14-2.59-1.42-3.26-1.62-.93-.29-2.9-.45-3.88-.42-.85.03-3.27.13-3.27.13l-1.1,1.51s.35-1.54.52-1.91c.38-.83,1.46-1.12,2.4-1.14s2.07-.07,3.02-.1c1.22-.03,5.78.22,5.6,1.34Z"/>
      <g id="nose">
        <path className="cls-18" d="M64.02,67.55c.15-.51,1.12-1.04,1.12-1.04,0,0,.42-.23.76-.16.22.04.25.17.49.32.31.2.62.21.97.22.31,0,1.11.03,1.68-.49.44-.4.42-.85.7-.87.27-.02.51.4.65.65.28.5.54,1.41.54,1.58.01.25-.03.58-.46,1.2-.67.95-2.05,1.2-2.75,1.25-.55.04-1.37-.16-2.15-.63-.74-.45-1.75-1.36-1.55-2.04Z"/>
        <path className="cls-14" d="M64.04,67.79c-.13.13.33.87.92,1.41.2.18.61.52,1.24.76.41.16,1.43.47,2.6.11.77-.24,1.24-.66,1.35-.76.51-.47.86-1.1.76-1.19-.09-.08-.45.34-1.14.65-.9.41-1.75.35-2.16.32-1.13-.08-2.03-.52-2.49-.76-.67-.34-.99-.63-1.08-.54Z"/>
      </g>
      <g id="eyes">
        <g id="right-eye">
          ...
          <g id="pupil">
            <circle className="cls-15" cx="80.16" cy="57.81" r="2.73"/>
        ...
        <g id="left-eye">
          ...
          <g id="pupil-2" data-name="pupil">
            <circle className="cls-15" cx="55.83" cy="57.81" r="2.73"/>
      ...
      <g id="mouth-embarrassed" className="cls-21">
        ...
        <g>
          ...
          <g>
            ...
            <path className="cls-17" d="M76.03,81.23c.04,1.47-1.9,2.42-1.9,2.42,0,0-4.21-.82-6.44-.82-1.77,0-6.34.84-6.34.84,0,0-2.07-.97-1.95-2.54.07-.95.8-1.83,2.1-2.48,1.47-.74,3.37-.32,5.73-.32,2.23,0,4.69-.4,6.2.15.65.23,2.55,1.11,2.59,2.75Z"/>
      ...
      <g id="cheeks-embarrassed" className="cls-21">
      ...
      <g id="eyes-embarassed" className="cls-21">
        <g id="right-eye-2" data-name="right-eye">
          ...
          <g id="pupil-3" data-name="pupil">
            <circle className="cls-15" cx="80.25" cy="57.82" r="2.65"/>
        ...
        <g id="left-eye-2" data-name="left-eye">
          ...
          <g>
            <circle className="cls-15" cx="55.73" cy="57.82" r="2.65"/>
      ...
      <g id="mouth-happy" className="cls-21">
