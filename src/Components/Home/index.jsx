...
<section className="h-[calc(100vh-3.5rem)] w-full bg-primary p-10 overflow-hidden">
        ...
        <div className="flex justify-center items-center h-full w-full z-0">
          <div
            id=""
            className="size-63 md:size-94 lg:size-104 xl:size-125 2xl:size-155  bg-black absolute rounded-full mx-auto z-0 border-tertiary drop-shadow-[18px_4px_10px_rgba(0,0,0,0.4)]"
          ></div>
          <div
            id="background"
            className="size-60 md:size-90 lg:size-100 xl:size-120 2xl:size-150 bg-secondary rounded-full mx-auto border-10 z-10 border-tertiary drop-shadow-[18px_4px_10px_rgba(0,0,0,0.3)] clipPath"
          >
            <svg
              className="drop-shadow-[49px_4px_4px_rgba(0,0,0,0.3)]"
              id="Layer_2"
              data-name="Layer 2"
                    ...
                    <g id="eyes-embarassed" className="cls-28">
                      ...
                      <g id="left-eye-2" data-name="left-eye">
                        ...
                        <g className="pupil" data-name="pupil">
                          ...
                          <circle className="cls-17" cx="57" cy="56.26" r=".63" />
                          <circle
                            className="cls-16"
                            cx="57.63"
                            cy="55.93"
