...
function Contact() {
  ...
  const talkTimeLine = useRef(null);
  ...
  useEffect(() => {
    ...
    gsap.set("#headband, #headset", { yPercent: -450, xPercent: -200 });
    gsap.set("#laptop", { xPercent: 150 });
  ...
  function animateFace() {
    ...
    gsap.to("#face-inner", { xPercent: x / 12, yPercent: y / 10 });
    gsap.to("#neck-shadow", { xPercent: x / 20, yPercent: y / 5 });
    gsap.to("#hair", { xPercent: -x / 50, yPercent: -y / 40, skewY: y / 100 });
    gsap.to(".pupil", { xPercent: x / 2, yPercent: y / 3 });
    gsap.to("#left-ear", { xPercent: (x / 10) * -1, yPercent: -y / 10 });
    gsap.to("#right-ear", { xPercent: (x / 10) * -1, yPercent: -y / 10 });
    gsap.to("#right-brow, #left-brow", { yPercent: eyebrowY });
    gsap.to("#headset", { xPercent: (x / 50) * -1, yPercent: -y / 25 });
  ...
  useEffect(() => {
    talkTimeLine.current = gsap.timeline({ paused: true, repeat: 0 });
    talkTimeLine.current
      .to("#mouth-happy", {
        delay: 0.5,
        duration: 0.1,
        opacity: 1,
  ...
  const triggerTalkingAnimation = () => {
    talkTimeLine.current.restart();
  };
  ...
  return (
    <div className="min-h-[calc(100vh-11rem)] w-10/12 m-auto grid md:grid-cols-2 grid-cols-1 gap-10 pb-20 pt-20">
        <div className="">
          ...
          <div className="hidden w-full p-3 bg-secondary drop-shadow-[0_0_15px_rgba(255,255,255,0.1)] rounded-2xl "></div>
        </div>
        <div className="bg-tertiary h-fit rounded-2xl p-5">
          <div className="h-1/2 overflow-hidden ">
            <div className="size-[10rem] md:size-[18rem] mb-6 bg-secondary clipPath rounded-full relative m-auto">
              <svg
                className="scale-90 drop-shadow-[25px_4px_4px_rgba(0,0,0,0.3)]"
                id="Layer_2"
                data-name="Layer 2"
                xmlns="http://www.w3.org/2000/svg"
                xmlnsXlink="http://www.w3.org/1999/xlink"
                viewBox="0 0 137.19 168.53"
              >
                <defs>
                  <style>
                    {`
      ...
      .cls-7, .cls-9, .cls-14, .cls-12, .cls-13 {
        fill-rule: evenodd;
      }
      ...
      `}
                  ...
                  <radialGradient
                    ...
                    fy="67.77"
                    r="5.05"
                    gradientTransform="translate(31.62)"
                  ...
                  <radialGradient
                    ...
                    fy="67.77"
                    r="5.05"
                    gradientTransform="translate(-52.24) rotate(-180) scale(1 -1)"
                    xlinkHref="#radial-gradient"
                  />
                </defs>
                <g id="me" data-name="Layer 1">
                  <g id="avatar-mixed">
                    <g id="sweater">
                      ...
                      <path
                        className="cls-27"
                        d="M41.9,102.35s1.49,5.01,4.06,7.96c1.72,1.98,3.74,4.3,7.24,6.38,5.34,3.17,10.36,3.53,12.65,3.68,6.26.39,10.88-1.28,11.79-1.62,2.19-.82,6.15-2.35,9.62-6.27,1.1-1.24,2.14-3.24,4.22-7.24,1.25-2.42,1.83-3.62,1.83-3.62l-1.53-.92-.51-1.56-.38-.81c-.23-.49-.6-.9-1.07-1.17-.4-.23-.86-.5-1.13-.62-.23-.1-.47-.17-.72-.19l-.8-.07c-.26-.02-.53.03-.77.14l-.51.24.23.63s.35.56-.01,2.67c-.48,2.84-.8,3.67-1.69,5.11-.89,1.42-2.75,3.86-4.94,5.51-4.32,3.25-10.95,3.82-15.32,3.28-7.02-.86-10.99-4.83-11.82-5.8-1.75-2.04-2.92-3.88-3.32-6.06-.31-1.69-.05-3.91-.39-4.26-.35-.37-2.89.37-4.66,1.52-.6.39-.61,1.15-1.06,1.69-.47.57-1.02,1.41-1.02,1.41Z"
                      />
                      <path
                        className="cls-20"
                        d="M66.92,114.58l-.23,3.48c-.02.32-.3.56-.62.54l-2.67-.23c-.32-.03-.56-.31-.53-.63l.32-3.41c.03-.31.3-.54.61-.52l2.57.15c.32.02.56.29.54.61Z"
                      />
                      <path
                        className="cls-20"
                        d="M68.55,117.94l-.22-3.3c-.02-.36.24-.67.6-.69l1.91-.13c.32-.02.61.2.68.51l.63,3.05c.07.36-.17.71-.53.77l-2.32.37c-.38.06-.72-.22-.75-.6Z"
                      />
                      <path
                        className="cls-20"
                        d="M59.06,117.42l.31.12c.76.28,1.6-.17,1.78-.97l.54-2.49c.08-.36-.14-.71-.5-.8l-.97-.23c-.36-.09-.72.13-.81.49l-.77,3.09c-.08.33.1.67.42.79Z"
                      />
                      <path
                        className="cls-20"
                        d="M56.55,116.21c-1.15.48-4.06-1.22-4.38-2.43-.27-1.02,2.01-3.25,2.01-3.25l4.14,2.31s-.8,2.97-1.76,3.38Z"
                      />
                      <path
                        className="cls-20"
                        d="M50.59,112.4c1.09-.05,3.14-3,3.14-3l-1.39-1.35s-3.39,1.86-3.47,3c-.04.55,1.18,1.38,1.72,1.35Z"
                      />
                      <path
                        className="cls-20"
                        d="M46.49,108.29c-.15.58.87,1.82,1.46,1.9,1.18.16,3.81-2.85,3.81-2.85,0,0-1.62-1.42-1.99-2.03-.53-.87-.98-2.93-1.21-3.89-.2-.8-.3-3.28-.3-3.28,0,0-3.19.47-3.96,1.51-.24.32-.62,1.6-.62,1.6,0,0,1.77-1.48,2.44-1.31.17.04.33.5.27.67-.22.66-2.38,1.46-2.38,1.46l.59,1.89s2.27-2.09,3.11-1.78c.2.07.38.62.29.81-.38.81-3.03,1.95-3.03,1.95,0,0,.42,2.15,1.03,2.32.94.27,3.24-2.16,3.24-2.16,0,0,.42.71.32.94-.37.88-2.85,1.33-3.08,2.25Z"
                      />
                      <path
                        className="cls-20"
                        d="M74.59,117.6l2.96-.86c.39-.11.59-.54.42-.91l-1.29-2.96c-.14-.32-.5-.48-.83-.36l-2.56.89c-.34.12-.52.48-.42.82l.89,2.94c.11.35.47.55.83.45Z"
                      />
                      <path
                        className="cls-20"
                        d="M80.12,115.51l2.14-1.29c.38-.23.45-.75.15-1.08l-2.24-2.4c-.23-.24-.59-.29-.87-.12l-1.82,1.11c-.35.21-.44.68-.2,1.01l1.92,2.58c.21.29.61.37.92.18Z"
                      />
                      <path
                        className="cls-20"
                        d="M84.47,112.2l1.33-1.16c.23-.2.21-.56-.04-.73l-2.68-1.87c-.22-.15-.27-.46-.1-.67l.19-.25c.15-.19.42-.23.62-.1l2.84,1.89c.21.14.49.09.63-.11l.56-.76c.16-.22.1-.52-.12-.67l-2.83-1.83c-.21-.13-.27-.4-.15-.62l.11-.21c.12-.22.39-.3.61-.19l3.07,1.52c.25.12.55,0,.64-.25l.25-.67c.08-.23-.02-.48-.24-.58l-3.03-1.43c-.23-.11-.33-.38-.23-.61l.02-.05c.1-.22.35-.34.58-.26l3.02,1.05c.27.09.57-.08.61-.37l.1-.62c.04-.22-.09-.43-.3-.51l-3.16-1.16c-.18-.07-.3-.24-.3-.44h0c0-.34.35-.56.66-.42l2.88,1.3c.27.12.59-.04.65-.34l.18-.94c.04-.19.17-.78,0-.88l-.11-.4c-.12-.31-.76-1.2-1.04-1.37l-1.59-.95c-.17-.11-.92-.23-1.12-.23h-1.1s.18,1.01.14,1.34l-.54,4.42c0,.06-.03.12-.06.17l-2.75,4.82s-.04.06-.06.09l-1.57,1.68c-.17.19-.17.48.02.65l2.77,2.69c.17.17.45.18.63.02Z"
                      />
                      <path
                        className="cls-27"
                        d="M67.58,125.18c-.89-.06-.72-2.72-2.6-3.6-.58-.27-2.4-.86-1.8-.65,0,0-.21.59-.22.87-.02.63.94,1.12,1.44,1.44,2.12,1.37,1.77,3.65,2.88,3.75.97.08.96-1.68,3.24-3.17.35-.22,1.07-.65,1.51-1.51.2-.39.46-1.08.22-1.3-.22-.2-.78.09-1.01.22-2.21,1.18-2.75,4.03-3.68,3.96Z"
                      />
                      <path
                        className="cls-27"
                        d="M74.04,122c-.12-.13.2-.45,1.5-2.31.39-.56.61-.89.88-.86.29.04.53.48.54.87.02.8-.93,1.4-1.51,1.76-.15.1-1.22.77-1.42.54Z"
                      />
                      <path
                        className="cls-27"
                        d="M61.28,121.62c.11-.14-.24-.43-1.69-2.18-.44-.53-.69-.84-.95-.78-.28.06-.49.52-.46.91.04.8,1.04,1.32,1.65,1.63.16.08,1.28.66,1.46.42Z"
                      />
                    </g>
                    <path
                      id="neck"
                    ...
                    <g id="left-ear">
                      <path
                        id="shadow"
                        className="cls-3"
                        d="M36.21,51.14c-.07-.04-.14-.06-.22-.07-.43-.07-1.98-.26-3.5.24-3.68,1.21-4.97,5.84-5.14,6.49-1.32,5,1.55,9.16,2,9.79.91,1.27,2.11,2.96,4.27,3.95,1.46.67,3.25.96,4.38,2.65.11.17.21.35.21.35.04.07.07.13.1.19.16.33.45.82.45.82,0,0,0,0,0,0,.54.45,2,0,2-1l-1-17.91c0-2.24-1.25-4.3-3.25-5.32l-.3-.15Z"
                      />
                      <path
                        className="cls-26"
                        d="M38.5,60.59c.15-.16.53-1.42-.04-5.33-.28-.38-.76-.91-1.51-1.24-2.11-.93-4.34.62-4.6.81-2.46,1.78-2.48,5.12-2.49,6-.02,3.67,2.23,6.14,2.87,6.81,0,0,1.25,2.14,5.41,3.81.18.07.77.02.93-.13.17-.17-.12-1.08-.18-1.24-.65-1.78-.39-5.73-.38-5.89.01-.17.05-.6-.22-.87-.19-.19-.4-.16-.65-.27-.5-.22-.68-.8-.81-1.14-.5-1.29-1.63-3.21-2.87-3.2-.29,0-.5-.07-.72-.29-.17-.17-.14-.32-.03-.54.14-.28.55-.26.75-.29,1.05-.17,1.56.56,1.98.83,1.75,1.13,2.44,2.29,2.55,2.17Z"
                      />
                      <path
                        className="cls-25"
                        d="M33,63.6c.26.75.68,1.92,1.73,3.06.4.44,1.44,1.54,3.1,1.95.49.12.54.36.78.25,0,0-.1-.61-.05-3.15.03-1.67,0-2.05,0-2.05,0,0-.43-1.02-2.39-3.13,0,0-1.09-2.05-2.26-1.83-.12.02-.53-.59-.77-.52-.36.1-.32.34-.4.49-.9,1.96.25,4.92.25,4.92Z"
                      />
                    </g>
                    <g id="right-ear">
                      <path
                        ...
                        data-name="shadow"
                        className="cls-3"
                        d="M98.1,51.14c.07-.04.14-.06.22-.07.43-.07,1.98-.26,3.5.24,3.68,1.21,4.97,5.84,5.14,6.49,1.32,5-1.55,9.16-2,9.79-.91,1.27-2.11,2.96-4.27,3.95-1.46.67-3.25.96-4.38,2.65-.11.17-.21.35-.21.35-.04.07-.07.13-.1.19-.16.33-.54.48-.89.38,0,0-.01,0-.02,0-.32-.1-.54-.39-.54-.73v-17.74c0-2.24,1.25-4.3,3.25-5.32l.3-.15Z"
                      />
                      <path
                        className="cls-26"
                      ...
                      <path
                        className="cls-25"
                        d="M102.22,63.6c-.26.75-.68,1.92-1.73,3.06-.4.44-1.44,1.54-3.1,1.95-.49.12-.54.36-.78.25,0,0,.1-.61.05-3.15-.03-1.67,0-2.05,0-2.05,0,0,.43-1.02,2.39-3.13,0,0,1.09-2.05,2.26-1.83.12.02.53-.59.77-.52.36.1.32.34.4.49.9,1.96-.25,4.92-.25,4.92Z"
                      />
                    </g>
                    <g id="face">
                      <path
                        id="neck-shadow"
                        className="cls-25"
                        d="M53.08,92.7c.14.43.39,1.07.92,1.68.51.59.93.76,1.62,1.35.84.71,1.25,1.34,1.57,1.73,1.41,1.75,3.99,2.74,4.87,3.08,3.74,1.44,7.08.87,8.6.59,0,0,3.64-.67,6.81-2.87,1.89-1.31,2.7-2.54,2.97-2.97.28-.45.79-2.43.92-2.72"
                      />
                      <path
                        id="shadow-3"
                        data-name="shadow"
                    ...
                    <g id="face-inner">
                      <path
                        id="right-brow"
                        className="cls-29"
                        d="M89.8,53.1c.32-.32-.98-2.81-2.2-4.07-3.96-4.1-9.76-3.77-12.22-2.85-.44.17-1.11.48-1.51,1.15-.67,1.13-.37,2.88.54,3.5.9.61,2.15-.06,3.24-.4,5.53-1.7,12.15,2.67,12.15,2.67Z"
                      />
                      <path
                        id="left-brow"
                        className="cls-29"
                        d="M46.2,53.1c-.32-.32.98-2.81,2.2-4.07,3.96-4.1,9.76-3.77,12.22-2.85.44.17,1.11.48,1.51,1.15.67,1.13.37,2.88-.54,3.5-.9.61-2.15-.06-3.24-.4-5.53-1.7-12.15,2.67-12.15,2.67Z"
                      />
                      <g id="cheeks">
                        <path
                          className="cls-25"
                          d="M88.44,67.77c0,.93-1.49,1.68-2.74,1.68s-2.27-.61-2.27-1.53,1.49-1.82,2.74-1.82,2.27.75,2.27,1.68Z"
                        />
                        <path
                          className="cls-25"
                          d="M46.67,67.77c0,.93,1.49,1.68,2.74,1.68s2.27-.61,2.27-1.53-1.49-1.82-2.74-1.82-2.27.75-2.27,1.68Z"
                        />
                      </g>
                      <path
                        id="right-eye2"
                        d="M75.09,56.3c.03.2-.11,1.68.04,2.22.04.14,2.59-1.42,3.26-1.62.93-.29,2.9-.45,3.88-.42.85.03,3.27.13,3.27.13l1.1,1.51s-.35-1.54-.52-1.91c-.38-.83-1.46-1.12-2.4-1.14s-2.07-.07-3.02-.1c-1.22-.03-5.78.22-5.6,1.34Z"
                      />
                      <path
                        id="left-eye2"
                        d="M60.89,56.43c-.03.2.11,1.68-.04,2.22-.04.14-2.59-1.42-3.26-1.62-.93-.29-2.9-.45-3.88-.42-.85.03-3.27.13-3.27.13l-1.1,1.51s.35-1.54.52-1.91c.38-.83,1.46-1.12,2.4-1.14s2.07-.07,3.02-.1c1.22-.03,5.78.22,5.6,1.34Z"
                      />
                      <g id="nose">
                        <path
                          className="cls-25"
                          d="M64.02,67.55c.15-.51,1.12-1.04,1.12-1.04,0,0,.42-.23.76-.16.22.04.25.17.49.32.31.2.62.21.97.22.31,0,1.11.03,1.68-.49.44-.4.42-.85.7-.87.27-.02.51.4.65.65.28.5.54,1.41.54,1.58.01.25-.03.58-.46,1.2-.67.95-2.05,1.2-2.75,1.25-.55.04-1.37-.16-2.15-.63-.74-.45-1.75-1.36-1.55-2.04Z"
                        />
                        <path
                          className="cls-22"
                          d="M64.04,67.79c-.13.13.33.87.92,1.41.2.18.61.52,1.24.76.41.16,1.43.47,2.6.11.77-.24,1.24-.66,1.35-.76.51-.47.86-1.1.76-1.19-.09-.08-.45.34-1.14.65-.9.41-1.75.35-2.16.32-1.13-.08-2.03-.52-2.49-.76-.67-.34-.99-.63-1.08-.54Z"
                        />
                      </g>
                      <g id="eyes">
                        <g id="right-eye">
                          <path
                            className="cls-18"
                            d="M84.64,57.56c0,2.52-1.68,4.11-4.2,4.11s-4.92-1.59-4.92-4.11c0-1.03.35-1.54.96-2.28.7-.85,2.11-1.16,3.61-1.16s2.81.31,3.62,1.16c.69.72.94,1.2.94,2.28Z"
                          />
                      ...
                      <g id="mouth">
                        <path
                          className="cls-3"
                          d="M67.93,77.24c6.51-.01,8.17-.19,12.98-1.33,1.65-.03,1.96.71,1.63,1.74-.44.6-1.61-.07-2.5.61-3.66,3.58-5.01,5.95-11.93,6.1-9.25-.38-8.46-4.58-14.65-7.27-.1-2.28,1.28-.55,3.86-.34,2.6.54,9.66.5,10.6.49Z"
                        />
                        <path
                          className="cls-5"
                          d="M71.34,78.85c-3.37.19-8.28.05-11.93-.53-.35-.06-.67.33-.48.63,2.49,3.76,6.37,3.93,11.15,3.64s10.94-5.44,5.11-4.17"
                        />
                        <path
                          className="cls-4"
                          d="M72.55,80.93c-2.87.3-5.77.3-8.64,0l-3.62-.38c2.45,2.2,5.8,2.29,9.78,2.05,2.03-.12,4.22-1.04,5.71-2.01l-3.24.34Z"
                        />
                      </g>
                      <g id="mouth-embarrassed" className="cls-28">
                        <path
                          className="cls-3"
                          d="M77.85,81.11c0,2.88-4.54,5.22-10.13,5.22s-10.13-2.34-10.13-5.22c0-1.35,1-2.59,2.64-3.52,1.85-1.05,4.24-.46,7.2-.46,2.8,0,5.62-.66,7.45.28s2.97,2.25,2.97,3.69Z"
                        />
                        <g>
                          <path
                            className="cls-2"
                            d="M76.04,81.24c0,2.1-3.73,3.81-8.32,3.81s-8.32-1.7-8.32-3.81c0-.99.82-1.89,2.17-2.56,1.52-.76,3.48-.33,5.92-.33,2.3,0,4.62-.48,6.12.21s2.44,1.64,2.44,2.69Z"
                          />
                          <g>
                            <path
                              className="cls-21"
                              d="M61.35,83.67s2.65-1.4,3.9-1.61c3.52-.62,5.68-.12,6.45.09.67.18,2.43,1.5,2.43,1.5,0,0-1.23.8-3.57,1.15-3.17.48-3.73.27-5.89-.03-1.89-.26-3.32-1.09-3.32-1.09Z"
                            />
                            <path
                              className="cls-24"
                              d="M76.03,81.23c.04,1.47-1.9,2.42-1.9,2.42,0,0-4.21-.82-6.44-.82-1.77,0-6.34.84-6.34.84,0,0-2.07-.97-1.95-2.54.07-.95.8-1.83,2.1-2.48,1.47-.74,3.37-.32,5.73-.32,2.23,0,4.69-.4,6.2.15.65.23,2.55,1.11,2.59,2.75Z"
                            />
                            <path
                              className="cls-18"
                              d="M61.35,78.78s3.54.89,5.87.94c0,0,2.26.05,4.99-.77.32-.09,1.23-.48,1.23-.48,0,0-.81-.29-1.9-.31-.75-.02-1.64.08-2.51.12-1.74.07-3-.17-4.17-.11-.65.03-1.49.05-1.95.11-1.06.14-1.56.5-1.56.5Z"
                            />
                          </g>
                        </g>
                      </g>
                      <g id="cheeks-embarrassed" className="cls-28">
                        <path
                          className="cls-6"
                          d="M91.88,67.77c0,2.19-3.52,3.97-6.49,3.97s-5.38-1.44-5.38-3.63,3.52-4.31,6.49-4.31,5.38,1.78,5.38,3.97Z"
                        />
                        <path
                          className="cls-1"
                          d="M43.24,67.77c0,2.19,3.52,3.97,6.49,3.97s5.38-1.44,5.38-3.63-3.52-4.31-6.49-4.31-5.38,1.78-5.38,3.97Z"
                        />
                      </g>
                      <g id="eyes-embarassed" className="cls-28">
                        <g id="right-eye-2" data-name="right-eye">
                          <path
                            className="cls-18"
                            d="M84.41,57.5c0,2.38-1.75,3.11-4.12,3.11s-4.48-.74-4.48-3.11c0-.97.33-1.45.9-2.15.66-.8,1.99-1.1,3.4-1.1s2.65.3,3.42,1.1c.65.68.88,1.13.88,2.15Z"
                          />
                        ...
                        <g id="left-eye-2" data-name="left-eye">
                          ...
                          <path
                            className="cls-19"
                            d="M49.15,59.35c.03-.22-.04-1.98.59-3.85.46-1.37,4.09-2.53,6.31-2.55,1.97-.02,3.99.5,4.72,2.55.77,2.17.44,4.53-1.92,5.5-.77.32-1.63.34-2.42.35-1.56.03-2,0-3.58-.38-.3-.07-.82-.5-1.04-.76-1.5-1.75-1.08-2.71-1.02-3.26.08-.74-1.5,2-1.64,2.39ZM55.62,60.46c2.38,0,4.56-.51,4.56-2.89,0-.97-.33-1.45-.9-2.15-.66-.8-1.99-1.1-3.4-1.1s-2.65.3-3.42,1.1c-.65.68-.99,1.14-.88,2.15.26,2.39,1.67,2.89,4.04,2.89Z"
                          />
                        </g>
                      </g>
                      <g id="mouth-happy" className="cls-28">
                        <path
                          className="cls-3"
                          d="M67.39,77.53c7.19-.01,7.9-1,13-1,2,0,2.36-.13,2,1-.49.66-2.26,1.01-3,2-3,4-4.32,8.89-11.96,9.05-10.21-.42-7.21-8.08-14.04-11.05-.11-2.52,1-1,2.67-1.08,2.87.59,10.3,1.09,11.33,1.08Z"
                        />
                        <path
                          className="cls-2"
                          d="M59.95,78.49c-1.3.25-2.02.58-2.06,1.04-.06.72.15.9.27,1.16,1.35,2.86,3.23,4.2,3.23,4.2.84.6,3.22,2.09,6.46,1.84,2.44-.18,4-1.25,5.99-2.61,0,0,2.38-1.63,4-4.61.15-.29.42-.81.2-1.18-.3-.51-1.34-.41-1.9-.36-2.99.3-4.48.45-5.69.61-.96.13-3.33.44-6.2,0-.98-.15-2.46-.46-4.3-.1Z"
                        />
                        <path
                          className="cls-5"
                          d="M58.5,78.27c-.68.53-.62,1.26-.62,1.26l19.78.27s.86-.86.21-1.88"
                        />
                      </g>
                    </g>
                    <g id="laptop">
                      <path
                        className="cls-10"
                        d="M31.82,116.03h73.14c2.17,0,3.93,1.76,3.93,3.93v48.07H27.89v-48.07c0-2.17,1.76-3.93,3.93-3.93Z"
                      />
                      <path
                        className="cls-15"
                        d="M71.86,140.71c.02,1.72,1.51,2.29,1.52,2.29-.01.04-.24.81-.78,1.61-.47.69-.96,1.38-1.74,1.39-.76.01-1-.45-1.87-.45s-1.14.44-1.86.46c-.75.03-1.31-.75-1.79-1.44-.97-1.41-1.72-3.98-.72-5.71.5-.86,1.38-1.41,2.35-1.42.73-.01,1.42.49,1.87.49s1.29-.61,2.17-.52c.37.02,1.41.15,2.07,1.12-.05.03-1.24.72-1.23,2.16M70.44,136.49c.4-.48.66-1.15.59-1.81-.57.02-1.26.38-1.67.86-.37.42-.69,1.1-.6,1.75.64.05,1.29-.32,1.68-.8"
                      />
                    </g>
                    <g id="headset">
                      <path
                        className="cls-7"
                        d="M27.76,52.12h-1.06c-.71,0-1.3.58-1.3,1.3v16c0,.71.58,1.3,1.3,1.3h1.06v-18.59Z"
                      />
                      <path
                        className="cls-13"
                        d="M30.89,59.1v-8.61c-.56-1.43-.76-3.34-.8-5.46h-1.84c.41,7.26,1.03,12.24,2.64,14.07h0Z"
                      />
                      <path
                        className="cls-12"
                        d="M34.86,49.07h1.32c1.22,0,2.21,1,2.21,2.21v20.28c0,1.22-1,2.21-2.21,2.21h-1.32v-24.7Z"
                      />
                      <path
                        className="cls-9"
                        d="M35.12,73.59l-3.73-.06c.01,16.84,16,19,32,16v2c-16,2-34.27,1.89-34.27-17.97"
                      />
                      <path
                        className="cls-13"
                        d="M33.71,48.13h-1.92c-1.95,0-4.02,1.6-4.02,3.55v19.47c0,1.95,2.07,3.55,4.02,3.55h1.92c.63,0,1.15-.52,1.15-1.15v-24.27c0-.63-.52-1.15-1.15-1.15h0Z"
                      />
                      <rect
                        className="cls-8"
                        x="32.11"
            ...
            <form>
              <div>
                ...
                <input
                  ...
                  type="text"
                  id="name"
                  onFocus={triggerTalkingAnimation}
                  onClick={triggerTalkingAnimation}
                />
              </div>
              <div>
                <label className="opacity-50" htmlFor="name">
              ...
              <div>
                ...
                <textarea
                  className="h-10 w-full bg-tertiary rounded-sm mt-1 p-1.5 mb-3 block resize-none text-center"
                  type="text"
                  id="name"
                  onFocus={triggerTalkingAnimation}
                  onClick={triggerTalkingAnimation}
